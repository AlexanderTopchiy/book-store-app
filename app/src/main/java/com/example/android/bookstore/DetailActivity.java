...
public class DetailActivity extends AppCompatActivity implements
    ...
    /** EditText field to enter the author's name */
    ...
    /** TextView field to see the quantity */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuantityTextView = findViewById(R.id.view_book_quantity);
    ...
    private void saveBook() {
        ...
        String priceInDollars = mPriceEditText.getText().toString().trim();
        ...
        // Convert price from dollars to cents and check the value.
        long priceInCents = 0;
        priceInDollars = priceInDollars.replace("$", "");
        priceInDollars = priceInDollars.replace(".", "");
        if (!TextUtils.isEmpty(priceInDollars)) {
            priceInCents = Long.parseLong(priceInDollars);
        }
        values.put(BookEntry.COLUMN_BOOK_PRICE, priceInCents);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierPhoneNumberColumnIndex = cursor.getColumnIndex(BookEntry
            ...
            mPriceEditText.setText(priceInDollars);
    ...
    public void decreaseQuantity(View view) {
        TextView quantityTextView = findViewById(R.id.view_book_quantity);
        String quantityValue = quantityTextView.getText().toString();
        int quantityIntValue = 0;
        if (quantityValue.matches("\\d+")) {
            quantityIntValue = Integer.parseInt(quantityValue);
        } else {
            Toast.makeText(this, getString(R.string.decrease_quantity_not_number),
                    Toast.LENGTH_SHORT).show();
        }
        quantityIntValue--;
        ...
        quantityTextView.setText(Integer.toString(quantityIntValue));
    }
